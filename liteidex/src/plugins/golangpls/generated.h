...
public:
	...
	virtual ~SemanticTokensClientCapabilities() {
		...
		if(m_tokenTypes) { delete m_tokenTypes; }
		if(m_tokenModifiers) { delete m_tokenModifiers; }
		if(m_formats) { delete m_formats; }
...
class ProgressToken: virtual public GoPlsParams {
...
public:
	...
	QJsonObject toJson() const {
		QJsonObject obj;
		if(m_workDoneToken) {
			QJsonObject workDoneToken = m_workDoneToken->toJson();
	...
	void fromJson(const QJsonObject &json) {
		if(json.contains("workDoneToken")) {
			auto workDoneToken = new ProgressToken();
			workDoneToken->fromJson(json.value("workDoneToken").toObject());
...
public:
	...
	QJsonObject toJson() const {
		...
		if(m_partialResultToken) {
			QJsonObject partialResultToken = m_partialResultToken->toJson();
	...
	void fromJson(const QJsonObject &json) {
		if(json.contains("partialResultToken")) {
			auto partialResultToken = new ProgressToken();
			partialResultToken->fromJson(json.value("partialResultToken").toObject());
...
public:
	...
	QJsonObject toJson() const {
		QJsonObject obj;
		if(m_token) {
			QJsonObject token = m_token->toJson();
	...
	void fromJson(const QJsonObject &json) {
		if(json.contains("token")) {
			auto token = new ProgressToken();
			token->fromJson(json.value("token").toObject());
			m_token = token;
		}
...
public:
	...
	virtual ~TextDocumentClientCapabilitiesSignatureInformation() {
		if(m_documentationFormat) { delete m_documentationFormat; }
...
public:
	...
	virtual ~CompletionTextDocumentClientCapabilitiesItemKind() {
		if(m_valueSet) { delete m_valueSet; }
	}
...
public:
	...
	virtual ~HoverTextDocumentClientCapabilities() {
		if(m_dynamicRegistration) { delete m_dynamicRegistration; }
		if(m_contentFormat) { delete m_contentFormat; }
	}
...
public:
	...
	virtual ~CompletionRegistrationOptions() {
		if(m_triggerCharacters) { delete m_triggerCharacters; }
...
public:
	...
	virtual ~ExecuteCommandRegistrationOptions() {
		if(m_commands) { delete m_commands; }
	}
...
public:
	...
	virtual ~ColorPresentation() {
		...
		if(m_additionalTextEdits) { delete m_additionalTextEdits; }
	}
...
public:
	...
	virtual ~WorkspaceEdit() {
		if(m_changes) { delete m_changes; }
		if(m_documentChanges) { delete m_documentChanges; }
		if(m_changeAnnotations) { delete m_changeAnnotations; }
	}
...
public:
	...
	virtual ~DocumentOnTypeFormattingRegistrationOptions() {
		...
		if(m_moreTriggerCharacter) { delete m_moreTriggerCharacter; }
	}
...
public:
	...
	virtual ~WorkspaceClientCapabilitiesWorkspaceEdit() {
		...
		if(m_resourceOperations) { delete m_resourceOperations; }
...
public:
	...
	virtual ~CallHierarchyOutgoingCall() {
		if(m_to) { delete m_to; }
		if(m_fromRanges) { delete m_fromRanges; }
	}
...
public:
	...
	virtual ~DidChangeWatchedFilesRegistrationOptions() {
		if(m_watchers) { delete m_watchers; }
	}
...
public:
	...
	virtual ~WorkspaceFoldersChangeEvent() {
		if(m_added) { delete m_added; }
		if(m_removed) { delete m_removed; }
	}
...
public:
	...
	virtual ~SignatureHelpOptions() {
		if(m_triggerCharacters) { delete m_triggerCharacters; }
		if(m_retriggerCharacters) { delete m_retriggerCharacters; }
	}
...
public:
	...
	virtual ~UnregistrationParams() {
		if(m_unregisterations) { delete m_unregisterations; }
	}
...
public:
	...
	virtual ~SignatureHelp() {
		if(m_signatures) { delete m_signatures; }
		if(m_activeParameter) { delete m_activeParameter; }
...
public:
	...
	virtual ~RegistrationParams() {
		if(m_registrations) { delete m_registrations; }
	}
...
public:
	...
	virtual ~DidChangeTextDocumentParams() {
		if(m_textDocument) { delete m_textDocument; }
		if(m_contentChanges) { delete m_contentChanges; }
	}
...
public:
	...
	virtual ~CodeActionOptions() {
		if(m_codeActionKinds) { delete m_codeActionKinds; }
		if(m_resolveProvider) { delete m_resolveProvider; }
	}
...
public:
	...
	virtual ~CompletionItem() {
		if(m_additionalTextEdits) { delete m_additionalTextEdits; }
		if(m_command) { delete m_command; }
		if(m_commitCharacters) { delete m_commitCharacters; }
		if(m_tags) { delete m_tags; }
		if(m_data) { delete m_data; }
		if(m_deprecated) { delete m_deprecated; }
		if(m_detail) { delete m_detail; }
