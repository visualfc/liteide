...
void KateHighlighter::setColorStyle(TextEditor::SyntaxHighlighter *highlighter,const ColorStyleScheme *scheme)
{
...
void KateHighlighter::setTabSize(SyntaxHighlighter *highlighter, int tabSize)
{
    if (!highlighter) {
        return;
    }
